            ...
            {availableChoices.length > 0 ? (
                availableChoices.map((choice, idx) => (
                    <button
                        ...
                        className={`text-[#3e2723] text-sm italic transition-all transform hover:scale-102 shadow-xl backdrop-blur-md border border-[#3e2723]/20 hover:border-[#3e2723]/50 whitespace-normal max-w-full
                            ${hasImage
