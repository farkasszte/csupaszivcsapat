...
- **Story Engine**: Interprets logic, jumps, branches, and variable changes from Arcweave.
- **State Management**: Tracks visits, variables, and history.
- **Audio Support**: Plays background audio attached to elements.
